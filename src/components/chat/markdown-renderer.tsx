        ...
        <div className={`prose prose-sm max-w-none ${className}`}>
            <ReactMarkdown
                components={{
                    ...
                    h2: ({ children }) => (
                        <h2 className="text-base font-semibold text-slate-800 mb-2 mt-3 first:mt-0">
                            {children}
                        </h2>
                    ),
                    h3: ({ children }) => (
                        <h3 className="text-sm font-semibold text-slate-700 mb-2 mt-3 first:mt-0">
                            {children}
                        </h3>
                    ),
                    ...
                    // Paragraphs
                    p: ({ children }) => (
                        <p className="text-slate-700 leading-relaxed mb-3 last:mb-0">
                            {children}
                        </p>
                    ),
